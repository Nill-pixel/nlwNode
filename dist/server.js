...
var require_client = __commonJS({
  "node_modules/.prisma/client/index.js"(exports2) {
    ...
    var config2 = {
      ...
      "inlineSchemaHash": "e3af68a063c9eb4027919609e83b78969c9bb920314b9137dd7fa64b9d70aa3f",
      "copyEngine": true
    };
    var fs2 = require("fs");
...
var createEvent = async (app2) => {
  app2.withTypeProvider().post("/events", {
    ...
    if (eventWithSameSlug !== null) {
      console.log(eventWithSameSlug !== null);
...
var registerForEvent = async (app2) => {
...
var getEventAttendees = async (app2) => {
...
app.register(import_swagger.default, {
  swagger: {
    ...
    info: {
      title: "pass.in",
      description: "Especifica\xE7\xF5es da API para back-end da aplica\xE7\xE3o pass.in contru\xEDda durante o NLW Unite da Rocketseat.",
      version: "1.0.0"
    }
  },
